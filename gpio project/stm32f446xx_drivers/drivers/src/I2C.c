...
*/
	...
	uint32_t temp = I2C1->SR1 | I2C1->SR2;  // read SR1 and SR2 to clear the ADDR bit
	(void)temp;
}
...
/**** STEP 1 ****/
	if (size == 1)
	{
		...
		/**** STEP 1-b ****/
		I2C1->CR1 &= (unsigned int)~(1<<10);  // clear the ACK bit
		uint32_t temp = (I2C1->SR1 | I2C1->SR2);  // read SR1 and SR2 to clear the ADDR bit.... EV6 condition
		(void)temp;
		I2C1->CR1 |= (1<<9);  // Stop I2C
